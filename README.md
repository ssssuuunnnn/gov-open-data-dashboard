...
以政府開放資料建置的靜態網站，整理十三個長照/老人福利相關資料集為互動式儀表板，可直接部署於 GitHub Pages。
...
不帶參數執行會重新下載十一份 CSV/JSON（長照ABC據點、巷弄長照站、桃園市老人福利機構一覽表、
銀髮族服務-居家長照機構、新竹縣長照機構名冊、宜蘭縣立案老人長期照顧及安養機構名冊、
新竹市老人福利機構一覽表、臺南市居家護理機構、臺中市一般護理之家清冊、新北市一般護理之家清冊、
屏東縣老人長期照顧機構）並覆寫對應 `data/*.json`；同時嘗試解析 `data/source/tp-ltc-specialty-*.pdf`
